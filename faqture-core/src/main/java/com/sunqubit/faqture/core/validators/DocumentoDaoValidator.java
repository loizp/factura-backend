...
public class DocumentoDaoValidator {
	...
	public void validaDocuLeyenda(TipoLeyenda docuTipoLeyenda, String docuLeyenda) throws ValidatorException{
		this.validaDocuTipoLeyenda(docuTipoLeyenda);
		
		if (docuLeyenda == null)
            throw new ValidatorException("Es necesario contener el atributo 'leyenda' del documento");
		
		if (docuLeyenda.length() > 250)
            throw new ValidatorException("la longitud del atributo 'leyenda' no debe exceder los 250 caracteres");
	}
	...
	public void validaDocuTipoLeyenda(TipoLeyenda docuTipoLeyenda) throws ValidatorException{
		if (docuTipoLeyenda == null || docuTipoLeyenda.getCodigo() == null)
            throw new ValidatorException("Es necesario contener el atributo 'tipoDocumento' del documento");
		
		if (docuTipoLeyenda.getCodigo().length() > 4)
            throw new ValidatorException("la longitud del atributo 'tipoDocumento.codigo' no debe exceder los cuatro caracteres");
	}
	...
	public void validaDocuLinkPdf(String docuLinkPdf) throws ValidatorException{
		if (docuLinkPdf == null || docuLinkPdf == null)
	...
	public void validaDocuLinkXml(String docuLinkXml) throws ValidatorException{
		if (docuLinkXml == null || docuLinkXml == null)
	...
	public void validaDocuLinkHashSunat(String docuHashSunat) throws ValidatorException{
		if (docuHashSunat == null || docuHashSunat == null)
	...
	public void validaDocuLinkCdr(String docuLinkCdr) throws ValidatorException{
		if (docuLinkCdr == null || docuLinkCdr == null)
	...
	public void validaDocuCdrStatus(String docuCdrStatus) throws ValidatorException{
		if (docuCdrStatus == null || docuCdrStatus == null)
	...
	public void validaDocuCdrNota(String docuCdrNota) throws ValidatorException{
		if (docuCdrNota == null || docuCdrNota == null)
	...
	public void validaDocuCdrObservacion(String docuCdrObservacion) throws ValidatorException{
		if (docuCdrObservacion == null || docuCdrObservacion == null)
